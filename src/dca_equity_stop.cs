...
namespace cAlgo.Robots
{
    ...
    public class GoldDcaBot : Robot
    {
        ...
        protected override void OnTick()
        {
            ...
            // STAGE 6: Equity stop — highest priority
            if (CheckEquityStop()) return;

            // STAGE 7: End-of-day flatten — close everything past cutoff
            if (IsPastCloseTime() && GetBasketPositions().Any())
            {
                CloseAllBasketPositions($"End of day — past {CloseAllHourUtc}:00 UTC");
                return;
            }

            // STAGE 4: Exit — profit target
            ...
            // STAGE 3/5: Entry — gated by filters
        ...
        {
            // Already triggered — stay locked out
            ...
            if (Account.Equity <= _equityStopLevel)
            {
                ...
                Print("========================================");
                CloseAllBasketPositions("Equity stop triggered");
                return true;
            }
